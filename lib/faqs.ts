...
export const STORE_FAQS = [
  ...
  },
  {
    ...
    answer:
      "You can modify or cancel your order within 1 hour of placing it. Contact our customer service immediately via WhatsApp or call 055 396 7658, or email hello@theperfumeempire.com. Once an order is processed, modifications may not be possible.",
  },
  {
    category: "orders",
  ...
  },
  {
    ...
    answer:
      "We accept MOMO (Mobile Money), Instant Bank Transfer, Cash (in store only), and Visa Card payment. Please note we do not accept payment on delivery.",
  },
  {
    category: "payment",
  ...
  },
  {
    ...
    answer:
      "For card and mobile money payments, you're charged immediately. We do not accept payment on delivery. Payment must be completed before dispatch. If an item is out of stock, we'll refund you within 24 hours.",
  },
  {
    category: "payment",
