...
If you see **404: NOT_FOUND** when opening your deployment URL (e.g. `https://perfume-empire-….vercel.app/`), Vercel is likely not building or serving the app as Next.js. Fix it as follows.

## 1. Set Framework and Build in the dashboard

1. Open [Vercel Dashboard](https://vercel.com/dashboard) and select your project (**perfume-empire**).
