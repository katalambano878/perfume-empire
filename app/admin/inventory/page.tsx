      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="w-12 h-12 flex items-center justify-center bg-brand-muted rounded-lg">
                <i className="ri-stack-line text-2xl text-brand"></i>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                ...
                className="bg-brand hover:bg-brand-dark text-white px-4 py-3 rounded-lg font-semibold transition-colors flex items-center space-x-2 whitespace-nowrap cursor-pointer"
              >
          ...
          {selectedProducts.length > 0 && (
            <div className="mt-4 flex items-center justify-between p-4 bg-cream border border-cream-dark rounded-lg">
              ...
              <div className="flex items-center space-x-3">
                <button
                  ...
                  className="bg-brand hover:bg-brand-dark text-white px-4 py-2 rounded-lg font-semibold transition-colors whitespace-nowrap cursor-pointer"
                >
                  Bulk Restock
                </button>
                <button
                ...
                <tr>
                  <th className="px-6 py-4 text-left">
                    <input
                      ...
                      className="w-5 h-5 text-brand rounded cursor-pointer"
                    />
                  </th>
                ...
                {loading ? (
                  ...
                  filteredProducts.map((product) => (
                    <tr key={product.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        {product.status === 'good' && (
                          <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-700 whitespace-nowrap">
