      ...
      <main className="min-h-screen bg-gray-50 flex items-center justify-center py-12">
        <div className="max-w-2xl mx-auto px-4">
          <div className="bg-white rounded-xl shadow-lg p-8 text-center">
            ...
            <div className="mb-8 p-6 bg-cream border border-cream-dark rounded-xl text-left">
              <h2 className="font-bold text-gray-900 mb-4 flex items-center">
                <i className="ri-mail-line text-2xl text-brand mr-2"></i>
                Check Your Email
              </h2>
              ...
              <ul className="text-sm text-gray-700 space-y-2">
                <li className="flex items-start space-x-2">
                  <i className="ri-checkbox-circle-fill text-brand mt-0.5"></i>
            ...
            <div className="mb-8 text-left">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  <div className="w-10 h-10 flex items-center justify-center bg-brand-muted rounded-full flex-shrink-0">
            ...
            <div className="space-y-3">
              <Link
                href="/account"
                className="block w-full bg-brand hover:bg-brand-dark text-white py-4 rounded-lg font-semibold transition-colors whitespace-nowrap"
              >
                Track Return Status
              </Link>
              <Link
          ...
          <div className="mt-8 bg-gold-light border border-gold-light rounded-xl p-6">
            <div className="flex items-start space-x-3">
              <i className="ri-alert-line text-2xl text-gold-dark mt-0.5"></i>
              <div>
                <p className="font-semibold text-brand-dark mb-2">Important Reminders</p>
                <ul className="text-sm text-gold-dark space-y-1">
