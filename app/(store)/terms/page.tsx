...
export const metadata = STORE_PAGE_SEO.terms;

export default function TermsPage() {
  return (
    <div className="min-h-screen bg-white">
      <div className="bg-gradient-to-br from-cream via-white to-gold-light py-16">
        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              By accessing and using this website (The Perfume Empire), you accept and agree to be bound by these Terms and Conditions. If you do not agree with any part of these terms, you must not use our website or services.
            </p>
          ...
          <section className="mb-12">
            ...
            <ul className="space-y-2 text-gray-600 mb-6">
              <li className="flex items-start gap-2">
                <i className="ri-arrow-right-s-line text-brand mt-1"></i>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              We accept the following payment methods (we do not accept payment on delivery):
            </p>
            <div className="bg-gray-50 p-6 rounded-xl mb-6">
              <ul className="space-y-2 text-gray-600">
                ...
                <li className="flex items-center gap-2">
                  <i className="ri-bank-line text-brand"></i>
                  <span>Instant Bank Transfer</span>
                </li>
                <li className="flex items-center gap-2">
                  <i className="ri-money-cny-circle-line text-brand"></i>
                  <span>Cash (in store only)</span>
                </li>
                <li className="flex items-center gap-2">
                  <i className="ri-bank-card-line text-brand"></i>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              All content on this website, including text, graphics, logos, images, videos, and software, is the property of The Perfume Empire or its content suppliers and is protected by copyright, trademark, and other intellectual property laws.
            </p>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            ...
            <ul className="space-y-2 text-gray-600 mb-6">
              <li className="flex items-start gap-2">
                <i className="ri-checkbox-circle-line text-brand mt-1"></i>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              To the fullest extent permitted by law, The Perfume Empire shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from:
            </p>
            <ul className="space-y-2 text-gray-600 mb-6">
              <li className="flex items-start gap-2">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed">
              You agree to indemnify and hold harmless The Perfume Empire, its affiliates, officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including legal fees) arising from your use of the website, violation of these terms, or infringement of any third-party rights.
            </p>
          </section>
            ...
            <div className="bg-gray-50 border border-gray-200 p-8 rounded-xl">
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <i className="ri-mail-line text-brand text-xl mt-1"></i>
                  <div>
                    <p className="font-medium text-gray-900">Email</p>
                    <a href="mailto:hello@theperfumeempire.com" className="text-brand hover:underline">hello@theperfumeempire.com</a>
                  </div>
                </div>

                <div className="flex items-start gap-3">
                  <i className="ri-phone-line text-brand text-xl mt-1"></i>
                  <div>
                    <p className="font-medium text-gray-900">Phone</p>
                    <a href="tel:+233553967658" className="text-brand hover:underline">055 396 7658</a> · WhatsApp <a href="https://wa.me/233553967658" className="text-brand hover:underline">055 396 7658</a>
                  </div>
                </div>

                <div className="flex items-start gap-3">
                  <i className="ri-map-pin-line text-brand text-xl mt-1"></i>
                  <div>
          ...
          <div className="bg-cream border-2 border-cream-dark p-8 rounded-xl text-center">
            <i className="ri-checkbox-circle-line text-4xl text-brand mb-4"></i>
            <p className="text-gray-600 leading-relaxed">
