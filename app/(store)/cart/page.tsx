...
export default function CartPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHero title="Shopping Cart" backgroundImage="/Whisk_a4071984faa45f6b45b4ac8f2119754ddr.jpeg" />
        ...
        {cartItems.length === 0 && savedItems.length === 0 ? (
          <section className="py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
              ...
              <Link href="/shop" className="inline-block bg-gray-900 hover:bg-brand text-white px-8 py-4 rounded-lg font-semibold transition-colors whitespace-nowrap">
                Continue Shopping
              </Link>
            </div>
          </section>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-6">
                  <div className="bg-white rounded-xl shadow-sm p-6 overflow-hidden">
                    <div className="flex items-center justify-between mb-6">
                      ...
                      {savings > 0 && (
                        <span className="text-brand font-semibold">You save GH₵{savings.toFixed(2)}</span>
                      )}
                    </div>
                        ...
                        <div key={`${item.id}-${item.variant || ''}`} className="flex flex-col sm:flex-row gap-4 sm:gap-6 pb-6 border-b border-gray-200 last:border-0 last:pb-0">
                          ...
                          <div className="flex-1">
                            <div className="flex justify-between mb-2">
                              <Link href={`/product/${item.slug || item.id}`} className="text-lg font-semibold text-gray-900 hover:text-brand transition-colors line-clamp-2">
                                {item.name}
                              </Link>
                              <button
                            ...
                            <div className="text-sm text-gray-600 mb-3 space-y-1">
                              ...
                              <p className="text-brand font-medium">In Stock</p>
                            </div>
                            ...
                            <button
                              ...
                              className="mt-3 text-sm text-brand hover:text-brand-dark font-medium whitespace-nowrap"
                            >
                              Save for Later
                            </button>
                            */}
                ...
                <div className="space-y-6">
                  <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
                    ...
                    <Link
                      href="/checkout"
                      className="block w-full bg-brand hover:bg-brand-dark text-white py-4 rounded-lg font-semibold text-center transition-colors mt-6 mb-3 whitespace-nowrap"
                    >
                      Proceed to Checkout
                    </Link>
                    ...
                    <Link
                      href="/shop"
                      className="block w-full text-center text-brand hover:text-brand-dark font-semibold py-2 whitespace-nowrap"
                    >
                      Continue Shopping
                    </Link>
                    ...
                    <div className="mt-6 pt-6 border-t border-gray-200 space-y-3">
                      <div className="flex items-center text-sm text-gray-600">
                        <i className="ri-shield-check-line text-brand mr-2"></i>
                        <span>Secure checkout</span>
                      </div>
                      <div className="flex items-center text-sm text-gray-600">
                        <i className="ri-arrow-left-right-line text-brand mr-2"></i>
                        <span>30-day returns</span>
                      </div>
                      <div className="flex items-center text-sm text-gray-600">
                        <i className="ri-customer-service-line text-brand mr-2"></i>
