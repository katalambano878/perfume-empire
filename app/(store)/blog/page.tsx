...
export const metadata = STORE_PAGE_SEO.blog;
...
export default function BlogPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
            ...
            <div className="grid md:grid-cols-2 gap-0">
              ...
              <div className="p-12 flex flex-col justify-center">
                <div className="flex items-center gap-4 text-sm text-gray-500 mb-4">
                  <span className="bg-gold-light text-gold-dark px-3 py-1 rounded-full font-medium">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-brand-muted rounded-full flex items-center justify-center">
                    <i className="ri-user-line text-brand"></i>
                  </div>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="mt-12 flex justify-center">
              <nav className="flex items-center gap-2">
                ...
                <button className="w-10 h-10 flex items-center justify-center bg-brand text-white rounded-lg cursor-pointer">
                  1
                </button>
                <button className="w-10 h-10 flex items-center justify-center border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
                  2
            ...
            <div className="bg-gray-50 rounded-2xl p-6 mb-8 sticky top-24">
              ...
              <div className="space-y-2">
                {categories.map((category, index) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <i className={`${category.icon} text-brand`}></i>
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                ...
                <form className="space-y-3">
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-brand focus:border-transparent text-sm"
                  />
                  <button
                    type="submit"
                    className="w-full bg-brand text-white py-3 rounded-xl font-medium hover:bg-brand-dark transition-colors whitespace-nowrap"
                  >
                    Subscribe
                  </button>
                </form>
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                ...
                <div className="flex flex-wrap gap-2">
                  {['Shopping', 'Quality', 'Reviews', 'Ghana', 'Delivery', 'Tips', 'Home', 'Style'].map((tag, index) => (
                    <button
                      key={index}
                      className="px-4 py-2 bg-white border border-gray-200 rounded-full text-sm text-gray-700 hover:border-brand hover:text-brand transition-colors cursor-pointer whitespace-nowrap"
                    >
                      #{tag}
                    </button>
                  ))}
      ...
      <div className="bg-gradient-to-br from-brand to-brand-dark py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            href="/shop"
            className="inline-flex items-center gap-2 bg-white text-brand px-8 py-4 rounded-full font-medium hover:bg-cream transition-colors whitespace-nowrap"
          >
            Explore Products
