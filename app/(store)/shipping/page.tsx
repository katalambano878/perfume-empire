...
export const metadata = STORE_PAGE_SEO.shipping;
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {deliveryOptions.map((option, index) => (
              <div key={index} className="bg-white border-2 border-gray-200 p-8 rounded-2xl hover:border-brand hover:shadow-lg transition-all">
                <div className="w-14 h-14 bg-brand-muted rounded-full flex items-center justify-center mb-6">
                  <i className={`${option.icon} text-2xl text-brand`}></i>
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-2">{option.type}</h3>
                <div className="text-brand font-bold text-xl mb-2">{option.cost}</div>
        ...
        <div className="bg-cream border-2 border-cream-dark rounded-2xl p-8 mb-16 text-center">
          ...
          <p className="text-lg text-gray-600">
            Spend GHS 300 or more and get <span className="font-bold text-brand">FREE standard delivery</span> anywhere in Ghana
          </p>
        </div>
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-10 h-10 bg-brand-muted rounded-full flex items-center justify-center">
            ...
            <div className="bg-gray-50 rounded-2xl p-6 space-y-6">
              <div>
                <h3 className="font-bold text-gray-900 mb-2 flex items-center gap-2">
                  <i className="ri-time-line text-brand"></i>
                  Cut-off Times
                </h3>
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2 flex items-center gap-2">
                  <i className="ri-calendar-line text-brand"></i>
                  Business Days
                </h3>
                <p className="text-gray-600 leading-relaxed text-sm">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2 flex items-center gap-2">
                  <i className="ri-phone-line text-brand"></i>
                  Delivery Contact
                </h3>
                <p className="text-gray-600 leading-relaxed text-sm">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2 flex items-center gap-2">
                  <i className="ri-home-line text-brand"></i>
                  Failed Deliveries
                </h3>
                <p className="text-gray-600 leading-relaxed text-sm">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2 flex items-center gap-2">
                  <i className="ri-secure-payment-line text-brand"></i>
                  Package Security
                </h3>
                <p className="text-gray-600 leading-relaxed text-sm">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-16">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="w-12 h-12 bg-brand-muted rounded-full flex items-center justify-center mx-auto mb-3">
                <i className="ri-checkbox-circle-line text-2xl text-brand"></i>
              </div>
              <p className="font-medium text-gray-900">Order Confirmed</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-gold-light rounded-full flex items-center justify-center mx-auto mb-3">
                <i className="ri-package-line text-2xl text-gold-dark"></i>
              </div>
            ...
            <div className="text-center">
              <div className="w-12 h-12 bg-brand-muted rounded-full flex items-center justify-center mx-auto mb-3">
                <i className="ri-gift-line text-2xl text-brand"></i>
              </div>
          ...
          <div className="mt-8 text-center">
            <Link
              href="/order-tracking"
              className="inline-flex items-center gap-2 bg-brand text-white px-8 py-4 rounded-full font-medium hover:bg-brand-dark transition-colors whitespace-nowrap"
            >
        ...
        <div className="bg-gradient-to-br from-brand to-brand-dark rounded-2xl p-8 text-white text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 bg-white text-brand px-6 py-3 rounded-full font-medium hover:bg-cream transition-colors whitespace-nowrap"
            >
              Contact Support
            </Link>
            <Link
              href="/faqs"
              className="inline-flex items-center gap-2 bg-brand text-white px-6 py-3 rounded-full font-medium hover:bg-cream0 transition-colors whitespace-nowrap"
            >
              View FAQs
            </Link>
          </div>
