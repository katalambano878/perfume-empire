...
export default function FAQsPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'You can modify or cancel your order within 1 hour of placing it. Contact our customer service immediately via WhatsApp or call 055 396 7658, or email hello@theperfumeempire.com. Once an order is processed, modifications may not be possible.'
    },
    {
      category: 'orders',
