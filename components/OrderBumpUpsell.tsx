...
export default function OrderBumpUpsell({ products, onToggle }: OrderBumpUpsellProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-gold-light to-cream rounded-xl p-6 border-2 border-gold-light">
      ...
      <div className="mt-4 p-3 bg-gold-light rounded-lg">
        <p className="text-sm text-gold-dark font-medium text-center">
