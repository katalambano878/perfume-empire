        ...
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-2">
            ...
            <select
              ...
              className="px-4 py-2 pr-8 border-2 border-gray-300 rounded-lg text-sm font-medium text-gray-700 focus:border-brand focus:ring-2 focus:ring-brand-muted bg-white cursor-pointer"
            >
