...
export default function CookieConsent() {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t-4 border-brand shadow-2xl z-[9999] animate-slide-up">
        <div className="max-w-7xl mx-auto px-4 py-6">
          {!showPreferences ? (
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              <div className="flex items-start space-x-4 flex-1">
                <div className="w-12 h-12 flex items-center justify-center bg-brand-muted rounded-lg flex-shrink-0">
                  <i className="ri-cookie-line text-2xl text-brand"></i>
                </div>
                <div>
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed mb-3">
                    ...
                    <Link href="/privacy" className="text-brand hover:text-brand-dark font-medium ml-1 whitespace-nowrap">
                  ...
                  <label className="flex items-start space-x-2 cursor-pointer group">
                    <input
                      ...
                      className="w-4 h-4 mt-0.5 text-brand border-gray-300 rounded focus:ring-brand cursor-pointer"
                    />
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <button
                  ...
                  className={`flex-1 px-6 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap ${
                    acceptedTerms
                      ? 'bg-gray-900 hover:bg-brand text-white cursor-pointer'
                      : 'bg-gray-300 text-gray-500 cursor-not-allowed'
                  }`}
                >
                  Accept All
